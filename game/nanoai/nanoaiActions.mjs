...
export const nanoaiActions = new Map([
    ...
    ["debugLine", function (x, y, time = 1, thickness = 2, color = [255, 255, 255]) {
        return {
            x, y, time, t: 0,
            work: function (nano) {
                this.t += deltaTime;
    ...
    ["harvest", function (soil, harvested) {
        return {
            before: ["follow"],
            work: function (nano) {
