...
let bz = [
    ...
    return {colors: bz, colorMap}
  }
export let categorizedImages = []
loadImgArray("assets/wave/categorization", 33, imgs => {
    
    for (const img of imgs) {
        categorizedImages.push(decomposeImage(img))
    } 
})
//we're gonna need to rewrite all the initialization systems

//console.log(categorizedImages[0].color)
